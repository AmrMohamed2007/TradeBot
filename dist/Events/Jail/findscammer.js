    ...
    run: (client, interaction) => __awaiter(void 0, void 0, void 0, function* () {
        if (interaction.isButton() && interaction.customId.startsWith("findscammer_")) {
            ...
            yield client.functions.get.GetUser(client.schemas, { status: "one", key: "guildid", value: interaction.guildId }).then((res) => __awaiter(void 0, void 0, void 0, function* () {
                ...
                yield interaction.showModal(yield client.public.ReturnModalSc(langdata, "find"));
            })).catch((err) => __awaiter(void 0, void 0, void 0, function* () {
                return yield interaction.reply({ content: `${langdata.panel.nopanel}`, ephemeral: true });
            }));
        }
    })
};
